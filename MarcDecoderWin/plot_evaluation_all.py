...
for MODEL_NAME in MODEL_NAMES:
    ...
    for test_dataset in TEST_DATASET:
        ...
        ax.plot(log_fid.qec_round, 1 - log_prob, ".", color="black")
        ...
        qec_offset = lmfit_par_to_ufloat(fit.params["round_offset"]).nominal_value
        ...
        fig.tight_layout()
        fig.savefig(MODEL_DIR / f"log_fid_{test_dataset}.pdf", format="pdf")
        fig.savefig(MODEL_DIR / f"log_fid_{test_dataset}.png", format="png")
